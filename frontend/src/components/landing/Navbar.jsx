...
export default function Navbar() {
  return (
    <header className="w-full sticky top-0 z-50 bg-amber-300 border-b-4 border-black">
      <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
        <a href="#" className="inline-flex items-center gap-3 group">
          <span className="px-3 py-1 bg-white text-black border-4 border-black font-black text-lg shadow-[4px_4px_0_0_#000] transition-all group-hover:shadow-[6px_6px_0_0_#000] group-hover:translate-x-[-2px] group-hover:translate-y-[-2px]">
            RB
          </span>
        ...
        <nav className="flex items-center gap-3">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="p-2 bg-white border-4 border-black shadow-[4px_4px_0_0_#000] transition-all hover:shadow-[6px_6px_0_0_#000] hover:translate-x-[-2px] hover:translate-y-[-2px]"
            aria-label="GitHub"
            title="GitHub"
          >
